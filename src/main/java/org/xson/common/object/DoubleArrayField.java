...
public class DoubleArrayField implements IField {
	...
	public DoubleArrayField(String name, double[] value) {
		this.name = name;
		this.value = value;
	}
	...
	protected void setValue(String var) {
		...
		for (int i = 0; i < size; i++) {
			value[i] = Double.parseDouble(list.get(i));
		}
	}
	...
	public IField cloneSelf() {
		return new DoubleArrayField(name, value.clone());
	}
