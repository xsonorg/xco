...
public class ShortArrayField implements IField {
	...
	private String arrayToString(short[] a) {
	...
	protected void setValue(String var) {
		...
		for (int i = 0; i < size; i++) {
			value[i] = Short.parseShort(list.get(i));
		}
	}
	...
	public IField cloneSelf() {
		return new ShortArrayField(name, value.clone());
	}
